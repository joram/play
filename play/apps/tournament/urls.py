...
urlpatterns = [
    ...
    url(r'^tournament/bracket/(?P<tournament_id>\w+)/edit/$', method_dispatch(
    ...
    url(r'^tournament/bracket/(?P<id>\w+)/csv$', method_dispatch(
        GET=tournament_views.tournament_bracket.show_csv,
    )),
